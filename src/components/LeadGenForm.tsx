...
const LeadGenForm = forwardRef<LeadGenFormRef, LeadGenFormProps>(({ userId, restoredSearch, onSearchRestored, urlRestoredCriteria, onStepChange }, ref) => {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-foreground mb-3 bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent">Generate Leads:</h2>
        <p className="text-base text-muted-foreground">
          1 million decision-makers, validated and ready when you are.
        </p>
      </div>
